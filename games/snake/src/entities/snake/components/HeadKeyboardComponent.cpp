...
{
    auto up = std::make_shared<SoundComponent>(this->_parent, "assets/snake/up.wav", SoundState::STOP, 100, false, HeadKeyboardComponent::_onSoundStateChangeUp);
    this->sounds["up"] = up;
    auto down = std::make_shared<SoundComponent>(this->_parent, "assets/snake/down.wav", SoundState::STOP, 100, false, HeadKeyboardComponent::_onSoundStateChangeDown);
    this->sounds["down"] = down;
    auto left = std::make_shared<SoundComponent>(this->_parent, "assets/snake/left.wav", SoundState::STOP, 100, false, HeadKeyboardComponent::_onSoundStateChangeLeft);
    this->sounds["left"] = left;
    auto right = std::make_shared<SoundComponent>(this->_parent, "assets/snake/right.wav", SoundState::STOP, 100, false, HeadKeyboardComponent::_onSoundStateChangeRight);
    this->sounds["right"] = right;
    auto eat = std::make_shared<SoundComponent>(this->_parent, "assets/snake/eat.wav", SoundState::STOP, 100, false, HeadKeyboardComponent::_onSoundStateChangeEat);
    this->sounds["eat"] = eat;
    auto death = std::make_shared<SoundComponent>(this->_parent, "assets/snake/death.wav", SoundState::STOP, 100, false, HeadKeyboardComponent::_onSoundStateChangeDeath);
