...
using namespace arcade::games::pacman::components;
using namespace shared::games::components;

HeadKeyboardComponent::HeadKeyboardComponent(PlayerEntity &entity) : AComponent(KEYBOARD, entity), _parent(entity) {}
