...
arcade::games::pacman::BackgroundEntity::BackgroundEntity(shared::types::Vector2u size) {
...
void arcade::games::pacman::BackgroundEntity::_addColor(shared::types::Vector2i position, shared::types::Vector2u origin) {
    shared::games::components::TextureProps textureProps = {
            .sources = {
                    .ascii = "assets/pacman/wall.ascii",
                    .bin = "assets/pacman/wall.png",
